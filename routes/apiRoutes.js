...
router.get("/index", indexDocuments, indexWords, (req, res) => {
    res.send({ "inputText": input_text, "indexedDocuments": docs, "indexedWords": words });
})

router.get("/search", searchWord, (req, res) => {
    search_word = req.query.search_word;
    res.send({ "inputText": input_text, "indexedDocuments": docs, "indexedWords": words, "searchWord": search_word, "searchWordDocs": search_word_docs });
})
...
router.get("/clear", (req, res) => {
    ...
    docs = {};
    words = {};
    res.redirect("Indices and indexed documents cleared");
})
